% ============================================================
% Pipeline 2 - Norepinephrine Escalation (Treatment Held)
...
% Head predicate
head_pred(treatment_held, 1).
type(treatment_held, (stay,)).
direction(treatment_held, (in,)).

% SOFA before norepinephrine
